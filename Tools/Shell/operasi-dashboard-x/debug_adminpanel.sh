...
echo "🔧 FIX: AdminPanel nil ServiceManager issue"

# Fix AdminPanel Handler - context sudah ada ServiceManager, tidak perlu panggil Get()
...
# Also fix TestOrder module yang belum punya init()
cat > Source/Core/Server/Modules/TestOrder/Handler.lua << 'EOF'
--!strict
...
echo "✅ FIX SELESAI: AdminPanel dan TestOrder sudah diperbaiki"
echo "🚀 Build dengan: rojo build -o place.rbxlx"
echo "🎯 TEST: Restart game dan coba Admin Panel - harusnya bekerja sekarang!"